...
<form action="pdeletePro.jsp?pageNum=<%=pageNum %>" method="post" id="join">
...
<input type="button" value="뒤로가기" onclick="location.href='plist.jsp'" class="cancel">
</div>
</form>
</article>
