...
Blist = Bdao.getBoardList(startRow, pageSize, search);
...
if(startNum != 1){
%>
<input type="button" value="PrePage" onclick="location.href='search.jsp?pageNum=<%=startNum-1%>'" class="page">
<%
}
// 1-10
if(endNum > pageCount){
...
for(int i = startNum; i <= endNum; i++){
	%>
	<a href="search.jsp?pageNum=<%=i %>">[<%=i %>]</a>
	<%
}
// 다음
if(endNum < pageCount){
%>
<input type="button" value="NextPage" onclick="location.href='search.jsp?pageNum=<%=endNum+1%>'" class="page">
<%
}
%>
